...
ProductionSuggestionId = NewType("ProductionSuggestionId", str)
LearningImportId = NewType("LearningImportId", str)
LearningProposalId = NewType("LearningProposalId", str)
